...
import useAllRingMetal from "../../../hooks/useAllRingMetal";
...
function DataTable() {
  ...
  const allRingMetal = useAllRingMetal(filterData);
  ...
  return (
    <>
      <Table
        scroll={{ x: 1000 }}
        columns={columns}
        dataSource={allRingMetal.data}
        bordered
        pagination={{
          current: filterData.current_page,
          pageSize: filterData.pageSize,
          total: allRingMetal.total,
