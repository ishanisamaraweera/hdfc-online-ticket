...
import useAllRingSize from "../../../hooks/useAllRingSize";
...
function DataTable() {
  ...
  const allRingSize = useAllRingSize(filterData);
  ...
  return (
    <>
      <Table
        scroll={{ x: 1000 }}
        columns={columns}
        dataSource={allRingSize.data}
        bordered
        pagination={{
          current: filterData.current_page,
          pageSize: filterData.pageSize,
          total: allRingSize.total,
