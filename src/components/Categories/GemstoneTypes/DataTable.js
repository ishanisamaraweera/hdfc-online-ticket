...
// import useAllGemTypes from "../../../hooks/useAllGemTypes";
...
function DataTable() {
  ...
  const allGemTypes = [];//useAllGemTypes(filterData);
  ...
  return (
    <>
      <Table
        scroll={{ x: 1000 }}
        columns={columns}
        dataSource={allGemTypes.data}
        bordered
        pagination={{
          current: filterData.current_page,
          pageSize: filterData.pageSize,
          total: allGemTypes.total,
