...
import useAllGemColors from "../../../hooks/useAllGemColors";
...
function DataTable() {
  ...
  const allGemColors = useAllGemColors(filterData);
  ...
  return (
    <>
      <Table
        scroll={{ x: 1000 }}
        columns={columns}
        dataSource={allGemColors.data}
        bordered
        pagination={{
          current: filterData.current_page,
          pageSize: filterData.pageSize,
          total: allGemColors.total,
